...
box = [0 100 0 100];
assertElementsAlmostEqual([50 50 100 50], clipEdge([50 50 150 50], box));
assertElementsAlmostEqual([50 50 0 50], clipEdge([50 50 -50 50], box));
assertElementsAlmostEqual([50 50 50 100], clipEdge([50 50 50 150], box));
assertElementsAlmostEqual([50 50 50 0], clipEdge([50 50 50 -50], box));

function testClipLastDiag
% test edges clipped at last extremity, with diagonal edges

box = [0 100 0 100];
assertElementsAlmostEqual([80 50 100 70], clipEdge([80 50 130 100], box));
assertElementsAlmostEqual([80 50 100 30], clipEdge([80 50 130 0], box));
assertElementsAlmostEqual([20 50 0 70], clipEdge([20 50 -30 100], box));
assertElementsAlmostEqual([20 50 0 30], clipEdge([20 50 -30 0], box));
assertElementsAlmostEqual([50 80 70 100], clipEdge([50 80 100 130], box));
assertElementsAlmostEqual([50 80 30 100], clipEdge([50 80 0 130], box));
assertElementsAlmostEqual([50 20 70 0], clipEdge([50 20 100 -30], box));
assertElementsAlmostEqual([50 20 30 0], clipEdge([50 20 0 -30], box));

function testClipFirst
% test edges clipped at first extremity, with orthogonal edges

box = [0 100 0 100];
assertElementsAlmostEqual([100 50 50 50], clipEdge([150 50 50 50], box));
assertElementsAlmostEqual([0 50 50 50], clipEdge([-50 50 50 50], box));
assertElementsAlmostEqual([50 100 50 50], clipEdge([50 150 50 50], box));
assertElementsAlmostEqual([50 0 50 50], clipEdge([50 -50 50 50], box));

function testClipFirstDiag
% test edges clipped at last extremity, with diagonal edges

box = [0 100 0 100];
assertElementsAlmostEqual([100 70 80 50], clipEdge([130 100 80 50], box));
assertElementsAlmostEqual([100 30 80 50], clipEdge([130 0 80 50], box));
assertElementsAlmostEqual([0 70 20 50], clipEdge([-30 100 20 50], box));
assertElementsAlmostEqual([0 30 20 50], clipEdge([-30 0 20 50], box));
assertElementsAlmostEqual([70 100 50 80], clipEdge([100 130 50 80], box));
assertElementsAlmostEqual([30 100 50 80], clipEdge([0 130 50 80], box));
assertElementsAlmostEqual([70 0 50 20], clipEdge([100 -30 50 20], box));
assertElementsAlmostEqual([30 0 50 20], clipEdge([0 -30 50 20], box));
